                    ...
                    <div className="auth-grid grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div className="auth-left p-10 bg-gradient-to-b from-gray-50 to-white border-b lg:border-b-0 lg:border-r">
                            ...
                            <p className="auth-subtitle text-gray-600 leading-relaxed mb-8">
                                학교 급식 서비스에 접속하려면 계정 정보로 로그인하세요.
                            </p>
                            ...
                            <div className="w-full max-w-md">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    ...
                                    <div className="rounded-lg border border-emerald-100 bg-emerald-50 px-4 py-3 mb-1">
                                        ...
                                        <p className="text-sm text-emerald-900">Email: student1@naver.com</p>
                                    ...
                                    <button
                                        ...
                                        className={`auth-btn auth-btn-primary w-full h-14 rounded-2xl font-bold text-white shadow-sm transition ${canLogin ? 'bg-[#00B3A4] hover:bg-[#009E91]' : 'bg-gray-300 cursor-not-allowed'
                                            }`}
                                    >
                                        {isLoading ? '로그인 중...' : '로그인'}
                                    </button>
