...
import dinnerImg from '../assets/20260224_dinner.png';
...
// ALLERGY_SHORT_NAMES를 알레르기 번호 -> 한글명 매핑으로 사용
const ALLERGEN_NAME = ALLERGY_SHORT_NAMES;
        ...
        return (
            <span className="text-sm ml-1">
                ...
                {allergenList.map((allergen, idx) => {
                    ...
                    return (
                        <span key={idx}>
                            <span className={isUserAllergy ? 'text-red-600 font-semibold' : `${darkMode ? 'text-gray-200' : 'text-gray-700'}`}>
                                {allergen}
                            </span>
        ...
        <>
            <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-md p-6`}>
                <div className="space-y-4">
                    ...
                    {noMenu ? (
                        <div
                            className={`rounded-lg border p-10 text-center ${darkMode ? 'bg-gray-700 border-gray-600' : 'bg-gray-50'
                                }`}
                        >
